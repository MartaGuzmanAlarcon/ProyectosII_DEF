...
% Media y desviacion mSQI para ventanas de 1h
...
for i = 1:length(archivos)
    ...
    num_muestras = length(geomMean_vector);
    ...
    for j = 1:num_bloques
        ...
        bloque = geomMean_vector(inicio:fin);
...
writetable(resultados, 'mSQI_1h_resultados_medias_desviaciones.csv');
